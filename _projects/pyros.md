...
layout: page
title: pyros
description: The PYROS (PYthon RecOmmender Systems library) python module offers some tools to build and evaluate recommender systems for implicit feedback.
...
### Source code
The source code is available on [GitHub](https://github.com/makgyver/pyros).
